...
function CarMaintenanceUpdate() {
  ...
  return (
    ...
    <div className="w-full h-56 overflow-hidden rounded-md relative mb-6">
      ...
      <button type="submit" className="w-full bg-[#192236] text-white py-2 rounded-md mt-4">Update Maintenance Detail</button>
    </form>
    </div>
    </>
  );
...
export default CarMaintenanceUpdate;
